    ...
    return (
        <div>
            <div className='my-5 text-center'>
                <p className="text-white text-3xl my-3 justify-center text-center font-bold bg-gray-800 rounded inline-block mx-9 lg:p-3 ">Please Leave us a feedback!</p>
            </div>
            <div className="hero-content flex-col lg:flex-row-reverse py-10 mx-auto">
                ...
                <div className="card flex-shrink-0 w-full max-w-lg shadow-2xl bg-base-100 order-last  lg:order-first xl:order-first">
                    <div className="card-body py-4">
                        ...
                        <div className="px-12 ">
                            <h2 className="text-gray-800 text-3xl my-3 justify-center text-center font-bold">Add A Review</h2>
                        </div>
                        <img src={divider} alt="" className='mb-3 w-40 mx-auto' />
                        <div className="bg-white w-full flex flex-col items-center rounded">
                            <div className="flex flex-col items-center  space-y-3">
                                <span className="text-lg text-gray-800 font-semibold my-3 mx-5">How was your experience at Tool Place?</span>
                            ...
                            <div className="w-3/4 flex flex-col pt-2">
                                <form onSubmit={handleSubmit(onSubmit)} >
                                    ...
                                    <button className="py-2 px-4 mb-6 text-lg bg-gradient-to-r from-orange-400 to-rose-400 rounded-xl text-white mx-auto w-full">Rate now</button>
                                </form>
