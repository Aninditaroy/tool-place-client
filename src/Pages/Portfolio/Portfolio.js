...
const Portfolio = () => {
    return (
        <div class="font-sans bg-white">
            ...
            <div class="mx-auto py-4  border-t-4 border-orange-400 px-28">
                <div class="flex justify-between items-center">
                    <div className='flex'>
                        <p class="text-gray-600 text-center mr-10 font-bold">&copy; Anindita Roy</p>
                        <p class="text-gray-600 text-center font-bold">Email: <span className='text-primary font-normal'>anindita.roy.mu@gmail.com</span></p>
                    </div>
